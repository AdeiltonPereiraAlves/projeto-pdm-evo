...
export default function AvaliacoesOng() {
    ...
    const handleExcluir = (avaliacaoId: string, voluntarioNome: string) => {
        Alert.alert(
            "Excluir Avaliação",
            `Deseja excluir sua avaliação para ${voluntarioNome}?`,
            [
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                <Text style={styles.headerTitle}>Avaliações da ONG</Text>
            </View>
                ...
                {avaliacoesExibidas.length === 0 ? (
                    <View style={styles.emptyContainer}>
                        ...
                        <Text style={styles.emptyText}>
                            {abaAtiva === "feitas"
                                ? "Avalie voluntários após participarem de suas vagas"
