...
export default function ConfiguracoesVoluntario() {
    ...
    const [notificacoesNovasVagas, setNotificacoesNovasVagas] = useState(true);
            ...
            >
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.card}>
                            ...
                            <View style={styles.settingInfo}>
                                ...
                                <View style={styles.settingTextContainer}>
                                    ...
                                    <Text style={styles.settingDescription}>
                                        Receba alertas sobre novas vagas
                                    </Text>
                                </View>
                            </View>
                            <Switch
                        ...
                        <View style={styles.settingItem}>
                            <View style={styles.settingInfo}>
                                <Icone nome="briefcase-outline" tamanho={24} color="#295CA9" />
                                <View style={styles.settingTextContainer}>
                                    <Text style={styles.settingTitle}>Novas Vagas</Text>
                                    <Text style={styles.settingDescription}>
                            ...
                            <Switch
                                value={notificacoesNovasVagas}
                                onValueChange={setNotificacoesNovasVagas}
                                trackColor={{ false: "#D1D5DB", true: "#93C5FD" }}
                                thumbColor={notificacoesNovasVagas ? "#295CA9" : "#f4f3f4"}
                            />
                        </View>
                    </View>
                </View>
